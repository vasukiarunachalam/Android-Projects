...
/*******************************************************************************
 * Created by VasukiSairam on 6/13/2015.
 * This code is the activity that takes in Pattern details from designer
 *******************************************************************************/

public class PatternAdmin extends Activity {
    int _i;
  ...
  /*  public static PatternAdmin newInstance(int num) {
        PatternAdmin f = new PatternAdmin();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        _i = intent.getIntExtra("i", 0); // here 0 is the default value

      //  getDialog().requestWindowFeature(Window.FEATURE_NO_TITLE);
        //setStyle(DialogFragment.STYLE_NORMAL, android.R.style.Theme_Black_NoTitleBar_Fullscreen);

        setContentView(R.layout.pattern_admin);
        v= getWindow().getDecorView().findViewById(android.R.id.content);
        pt_maker=new PatternMaker();
        textViewClicked=-1;
        edtImageid = (EditText) findViewById(R.id.edtImageid);
        ...
        rlayout=(RelativeLayout) findViewById(R.id.layoutimage);
        ...
        btnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                OnFinishDialog mcallBack = (OnFinishDialog)getApplicationContext();
                mcallBack.OnFinishDialog(true);
                PatternAdmin.this.finish();
          //      dismiss();
            }
        });
